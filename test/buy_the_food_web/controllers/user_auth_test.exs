defmodule BuyTheFoodWeb.UserAuthTest do
  use BuyTheFoodWeb.ConnCase, async: true

  alias BuyTheFood.Accounts
  alias BuyTheFoodWeb.UserAuth
  import BuyTheFood.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, BuyTheFoodWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      BuyTheFoodWeb.Endpoint.subscribe(live_socket_id)
