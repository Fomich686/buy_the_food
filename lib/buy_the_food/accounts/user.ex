defmodule BuyTheFood.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, BuyTheFood.Repo)
  ...
  """
  def valid_password?(%BuyTheFood.Accounts.User{hashed_password: hashed_password}, password)
